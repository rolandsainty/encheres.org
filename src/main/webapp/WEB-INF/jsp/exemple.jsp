	...
	<div class="container">
		<div class="jumbotron">
			<c:if test="${!empty user}">
				<h1>
					<spring:message code="welcome.title.attribute" arguments="${user}" />
				</h1>
			</c:if>

			<c:if test="${!empty userInSession.login}">

				<h1>
					<spring:message code="welcome.title.session"
						arguments="${userInSession.login}" />
				</h1>
